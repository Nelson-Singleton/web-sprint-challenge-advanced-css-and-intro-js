...
function get20s(arr){
  ...
  for (let i = 0; i <arr.length; i++){
      if(arr[i].years > 1899 < 2001){       //includes("18 - 20")){
      arr2.push(arr[i].name)                       //arr.splice(i, 1);
      }
...
function addArtist(arr, /*myId,*/ myName, myYears, myGenre, myNationality, myBio){

    arr.push({"id": arr.length + 1, "name": myName, "years": myYears, "genre": myGenre, "nationality": myNationality, "bio": myBio })
    return arr;

  }
  console.log("Task 6");
  console.log(addArtist(artists, /*20,*/ "Nelson Singleton", "1990-2020", "Web Design", "American", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque elementum fermentum nibh."))
